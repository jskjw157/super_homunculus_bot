...
### Discord 채팅으로 트레이딩 봇 개발
봇과 대화하며 크립토 트레이딩 시스템을 구축 — 데이터 수집, 차트 렌더링, 바이낸스 API 연동, AI 판단 엔진까지.

![트레이딩 봇 개발](images/image.png)

### 웹 브라우저 자동 조작
봇에게 웹사이트 스크린샷을 요청하면 실제 브라우저를 띄워 페이지를 캡처하고 결과를 전송합니다.

![웹 브라우저 조작](images/image2.png)

### 유튜브 영상 요약
유튜브 링크를 보내면 봇이 영상 내용을 요약해줍니다.

![유튜브 영상 요약](images/image3.png)
